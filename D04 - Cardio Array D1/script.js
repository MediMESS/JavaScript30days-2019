...
sort_asc_year_inventors = JSON.parse(JSON.stringify(inventors));
sort_desc_year_inventors = JSON.parse(JSON.stringify(inventors));
...
// Youngest to oldest
sort_desc_year_inventors.sort( (a, b) => {
  if (a.year > b.year)
    return -1;
  if (b.year > a.year)
    return 1;
...
console.log("Sort DESCENDING: ", sort_desc_year_inventors);
